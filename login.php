...
if(isset($_POST['submit']))
{
	...
	if($total)
	{
		...
		header("location:display-result.php");
	}
	else
	{
              ...
              <form action="" method="post">
                <div class="row">
                  <div class="col-md-12 form-group">
                    ...
                    <input type="text" id="name" class="form-control py-2" name="username">
                  </div>
                </div>
                <div class="row mb-5">
                  <div class="col-md-12 form-group">
                    <label for="name">Password</label>
                    <input type="password" id="name" class="form-control py-2" name="password">
                  </div>
                </div>
